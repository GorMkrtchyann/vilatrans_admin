...
const PhoneEdit = ({id, phone, setPhone}) => {
    ...
    const Submit = () => {
        setLoading(true)
        axios.put('http://localhost:8080/header/updatePhone', {
            id: id,
            obj: {
                phone: phone
            }
...
const MailEdit = ({id, mail, setMail}) => {
    ...
    const Submit = () => {
        setLoading(true)
        axios.put('http://localhost:8080/header/updateMail', {
            id: id,
            obj: {
                email: mail
            }
...
export const LogoEdit = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/header/getHeader').then(
            r => {
                if (!r.data.error) {
                    setId(r.data._id)
    ...
    const Submit = () => {
        setLoading(true)
        axios.put('http://localhost:8080/header/updateLogo', {
            id: id,
            obj: {
                logo: image
            }
