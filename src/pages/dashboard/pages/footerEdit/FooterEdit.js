...
const SocialEdit = ({socials, id, setFooterData}) => {
    ...
    const Submit = (data) => {
        setLoading(true)
        console.log(data)
        axios.put('http://localhost:8080/footer/updateSocialMedia', {
            id: id,
            obj: {
                social: data
            }
...
export const FooterEdit = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/footer/getFooter').then(
            r => {
                if (!r.data.error) {
    ...
    const Submit = () => {
        setLoading(true)
        axios.put('http://localhost:8080/footer/updateLogo', {
            id: footerData._id,
            obj: {
                logo: image
            }
