...
const ServicesEdit = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:8080/home/get-services').then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedData = await axios.put('http://localhost:8080/home/update-services', data);
    ...
    return (
        <>
            ...
            {reviewLoading ? <ServicesReview htmlContents={htmlContents} title={title}/> : <LinearProgress/>}
        </>
    );
}
