...
export const StepsPreview = ({
    ...
    return (
        <div>
            <section className="section bg--gray section-size">
                    ...
                    <div className="row bottom-70">
                        <div className="col-12">
                            <div className="heading heading--white">
                                <span className="heading__pre-title mb-0">
                                    {data.preTitle[language]}
                                </span>
                                <h3 className="heading__title heading--white">
                                    {data.title[language]}
                                </h3>
                            </div>
                        </div>
